...
See [release tags](https://github.com/wodby/apache/tags) for available revisions and the [image revision policy](https://github.com/wodby/images#image-revisions) for upgrade guidance.
